...
class Categoria(models.Model):
    idCategoria=models.IntegerField(verbose_name="idCategoria",primary_key=True,max_length=6)
    Nombre=models.CharField(verbose_name="Nombre",max_length=1000)
    idProducto=models.IntegerField(verbose_name="idProducto",max_length=100)
